...
- describe could mean a broader topic while it could be a specific topic, like describe could be "I'm making a sandwich" while it will be "getting bread from store"

1. What is the point of `Test Driven Development`? What do you think about this approach?

- Test Driven Development is create your test first before you do any logical code, it works best to maintain your code for years to come since if you add a new feature it may break something else and you won't be able to fix as easily as already having test showing you wants broken.
